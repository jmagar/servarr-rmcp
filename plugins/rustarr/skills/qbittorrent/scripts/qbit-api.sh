...
# LAST-RESORT direct-API path. Prefer the rustarr MCP tool (`mcp__rustarr__qbittorrent`)
# or the `rustarr qbittorrent` CLI when available (see SKILL.md). Creds come from
# rustarr's materialized env (~/.rustarr/.env, written by `rustarr setup
# plugin-hook`), then the legacy arrs config.env. RUSTARR_QBITTORRENT_* are aliases.
...
QBITTORRENT_URL="${QBITTORRENT_URL:-${RUSTARR_QBITTORRENT_URL:-}}"
QBITTORRENT_USERNAME="${QBITTORRENT_USERNAME:-${RUSTARR_QBITTORRENT_USERNAME:-}}"
QBITTORRENT_PASSWORD="${QBITTORRENT_PASSWORD:-${RUSTARR_QBITTORRENT_PASSWORD:-}}"

: "${QBITTORRENT_URL:?set RUSTARR_QBITTORRENT_URL (rustarr plugin settings) or QBITTORRENT_URL}"
: "${QBITTORRENT_USERNAME:?set RUSTARR_QBITTORRENT_USERNAME (rustarr plugin settings) or QBITTORRENT_USERNAME}"
: "${QBITTORRENT_PASSWORD:?set RUSTARR_QBITTORRENT_PASSWORD (rustarr plugin settings) or QBITTORRENT_PASSWORD}"
